...
public class DoubanMomenNews {
    ...
    public ArrayList<DoubanMomenNews.posts> getPosts() {
        return posts;
    }

    public void setPosts(ArrayList<DoubanMomenNews.posts> posts) {
        this.posts = posts;
    }
    ...
    public class posts {
        ...
        public class thumbs {
            ...
            public DoubanMomenNews.posts.medium getMedium() {
                return medium;
            }

            public void setMedium(DoubanMomenNews.posts.medium medium) {
                this.medium = medium;
            }
            ...
            public DoubanMomenNews.posts.large getLarge() {
                return large;
            }

            public void setLarge(DoubanMomenNews.posts.large large) {
                this.large = large;
            }
            ...
            public DoubanMomenNews.posts.small getSmall() {
                return small;
            }

            public void setSmall(DoubanMomenNews.posts.small small) {
                this.small = small;
            }
        ...
        public DoubanMomenNews.author getAuthor() {
            return author;
        }

        public void setAuthor(DoubanMomenNews.author author) {
            this.author = author;
        }
